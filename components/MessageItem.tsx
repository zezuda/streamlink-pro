  ...
  return (
    <div className="relative group/container">
      <button 
        ...
        className={`w-full text-left group relative p-4 rounded-xl transition-all border outline-none ring-offset-2 ring-offset-slate-900 ring-indigo-500 focus-visible:ring-2 ${
          message.isFeatured 
